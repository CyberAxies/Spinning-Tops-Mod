...
{ 
	...
	public class Waterwalker : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.knockBack = 3;
			Item.useTime = 55; // How long it takes to use the item (fire rate)
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.OceanTop>();
		...
		public override void AddRecipes()
		{
			...
			recipe.AddRecipeGroup("SpinningTopsMod:Seashell", 16); // Use the custom recipe group for ocean blocks
