...
namespace SpinningTopsMod.Content.Items
{
	...
	public class Blight : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.damage = 12;
			Item.crit = 6 -4; // Player has a base crit chance of 4, so we subtract it to get the actual crit chance
			Item.knockBack = 4f;
			Item.useTime = 53; // How long it takes to use the item (fire rate)
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.CorruptTop>();
