...
namespace SpinningTopsMod.Content.Projectiles
{
    ...
    public class DesertTop : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            // Downscale sprite from 32x32 to 16x16
            ...
            Projectile.timeLeft = 400 * 2; // How long the projectile lasts before disappearing
            ...
            Projectile.localNPCHitCooldown = 20; // Set the cooldown for hitting NPC
            Projectile.tileCollide = true; // Enable tile collision
            Projectile.light = 0.2f; // Add a light effect to the projectile
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.Sand, new Vector2 (0, -1f), 100, default, 1.5f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            else
            {
                if (damageDone > 0)
                {
                    // Spawn a clone of Rolling cactus thorn 
                    int clone = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center,
                        new Vector2(Projectile.velocity.X / 2, -1.75f), ProjectileID.RollingCactusSpike,
                        Projectile.damage / 2, Projectile.knockBack, Projectile.owner);

                    Main.projectile[clone].hostile = false; // Make the clone friendly
